                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">iOS • Safari • London, UK</p>
                    </div>
                  </div>
      ...
      return (
        <div className="space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {[
                { title: 'Security Alerts', description: 'Get notified about security updates', defaultChecked: true },
                { title: 'New Login', description: 'Get notified when a new device logs in', defaultChecked: true },
                { title: 'Account Updates', description: 'Get notified about account changes', defaultChecked: false }
              ].map((notification) => (
                <div key={notification.title} className="flex items-center justify-between">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" className="sr-only peer" defaultChecked={notification.defaultChecked} />
        ...
        <div className="space-y-6">
          <div className="bg-red-50 border border-red-200 rounded-md p-4">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <h3 className="text-red-600 font-medium">Delete Your Account</h3>
