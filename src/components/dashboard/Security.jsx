      ...
      <div className="space-y-4">
        ...
        <div className="pt-6">
          <h3 className="text-lg font-medium mb-4">
            ...
            <span className="text-green-600 p-1 text-sm font-normal  rounded-md bg-green-200 ">
              {is2FAEnabled ? "Enabled" : "Disabled"}
            </span>
            <br/>
            <span className="text-gray-400 text-sm">Protect your account by adding asn extra layer of security.</span>
          </h3>
          ...
          <button
            ...
            className={`${is2FAEnabled ? 'bg-red-200 text-red-600' : 'bg-white text-blue-600 border-blue-600 hover:bg-blue-50'} border mt-4   px-4 py-2 rounded-md  transition-colors disabled:opacity-50 disabled:cursor-not-allowed`}
          >
            {is2FALoading ? (
              <Loader className="animate-spin h-5 w-5" />
            ) : is2FAEnabled ? (
