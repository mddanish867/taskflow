      ...
      <div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <select className="px-3 py-2 border rounded-lg outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
          ...
          <div className="flex items-center justify-between">
            ...
            <select className="px-3 py-2 border rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
